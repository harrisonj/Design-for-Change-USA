    ...
    <div style="height: 300px;">
      ...
      <p class="normaltext">
        <div style="float: left; width: 100%;">
          <ol class="normallist">
            <li><b><a href="#portal">Start Your Project:</a></b> Create an account on our interactive portal where you'll be guided through starting your first DFC project.</li>
            <li><b><a href="#store">Curriculum:</a></b> Checkout the DFC Store to purchase the offline, print version of the curriculum, including a Teacher's Guide.</li>
            <li><b><a href="#tiers">Partner:</a></b> We can help you every step of the way - check out the different tiers of the Do Good Be Good Program.</li>
...
<div class="insidepage block2" style="margin-top: 0px; padding-top: 55px;">
  <div class="contents">
    <div style="height: 380px">
    	<a name="portal"></a>
      <h1>Start Your Project</h1>
      <p class="normaltext">Use our web portal to get started with your project and learn about the Design for Change process.</p>
      <div class="featurebox">
        <img src="/dfcusa/app/webroot/images/portal.png" class="portalscreen" width="300" style="margin-left: 0px; margin-right: 25px">
        <ul class="normallist" style="width: 500px">
          <span class="title">The free web portal helps you:</span>
          ...
          <a href="http://portal.designforchange.us" target="_new" class="button-outline white" style="margin-left: -20px; margin-top: 20px">Get Started</a>
        </ul>
      </div>
    </div>
  </div>
...
<div class="insidepage" style="margin-top: 0px; padding-top: 55px">
  <div class="contents">
    <div style="height: 220px">
      ...
      <a href="/dfcusa/pages/aboutus#contactus" class="button-outline white" style="margin-left: 10px; font-size: 10pt; height: 25px; line-height: 18pt">Get The Toolkit</a><br/></p>
      <div class="clear"></div>
    </div>
  </div>
</div>
