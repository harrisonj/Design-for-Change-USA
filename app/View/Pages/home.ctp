		...
		<section class="block1">
			<div class="container">
				<div class="inner1_design">
					...
					<div class="we_are">
						<h2>How It Works</h2>
						<p>Young people from around the United States do projects in their community that not only improve lives but help them build their character. <a href="/dfcusa/pages/howitworks">Learn more...</a></p>
					</div>
					<div class="clear"></div>
				</div>
			</div>
		...
		<section class="block2">
			<div class="container">
				<div class="inner_empower">
					...
					<h2>To Help Young People Be The Change<br/><span>We do this through...</span></h2>
