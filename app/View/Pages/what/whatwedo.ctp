...
<div class="insidepage">
  <div class="contents">
    <h1>What We Do</h1>
    <p class="normaltext">DESIGN FOR CHANGE (DFC) is a global movement of young people who are changing the world!</p>
    <p class="normaltext">
      <ul class="normallist">
        ...
        <li><b>What:</b> Teams are expected to fully implement, present and submit their social change project to DFC USA by the deadline: <b>May 15, 2016.</b></li>
        <li><b>And Then:</b> Each team is evaluated by an expert panel of judges, and is considered for the DFC Global Conference.</li>
      </ul>
    </p>
    <br/>
    <p class="normaltext">Through, Design for Change, young people and adults are learning that "I Can" are the two most powerful words a person can believe. Young people across the nation and the world are paving the way to a new future!</p>
    <br/>
    <p class="normaltext">Click here to see DFC stories from the USA and around the World: <a href="http://www.dfcworld.com" target="_new">www.dfcworld.com</a></p>
    <br/>
