...
<div class="insidepage">
	<div class="contents">
		...
		<p class="pagetitle">Important Details</p>
		<div class="normaltext">
			<ul>
				<li>-	<b>Deadline: May 15, 2015</b></li>
				<li>- <a href="/dfcusa/app/webroot/files/Design for Change - Video Brief 2015.pdf">Submission Guidelines</a></li>
			</ul>
		</div>
		<p class="pagetitle">Sample Video</p>
		<div class="normaltext">
			<ul>
				<li>- Winners of DFC USA 2013 - Crazy Horse High School, South Dakota</li>
				<li>- <a class="popup-youtube" href="https://www.youtube.com/watch?v=x5a6OtnohmU&feature=youtu.be">Watch their video here.</a></li>
			</ul>
		</div>
		<p class="pagetitle">Judging</p>
		<div class="normaltext">
			<ul>
				<li>- "To learn more about how judging is conducted..."</li>
				<li>- <a href="/dfcusa/app/webroot/files/Design for Change - Judging Rubric 2015.pdf">Judging Rubric 2015</a></li>
			</ul>			
		</div>
	</div>
</div>
