<div class="rightContent">
    ...
    <div class="normaltext" style="float: left; width: 100px">
		...
		<div class="normaltext" style="float: left; width: 100px">
			<img width="95" alt="" src="/dfcusa/images/sharwari.png">
		</div>
		<div class="normaltext">
			<br><br>
		...
		<div class="normaltext">
			<br><br>
			<b>Rachel Rosenbaum - Outreach and Graphic Design</b><br>
			<a href="mailto:rachel@designforchange.us">rachel@designforchange.us</a><br>
