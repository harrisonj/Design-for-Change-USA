<div class="leftnav">
  ...
  <ul>
    ...
    <li onclick="javascript:window.location.href = '/dfcusa/pages/about/media';" <?php if (strpos($_SERVER['REQUEST_URI'], '/pages/about/media') > -1) { ?>class="active"<?php } ?>><p>Media Coverage</p></li>
