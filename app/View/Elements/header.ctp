<header>
	<nav class="inner_nav">
		<div class="inner_logo"><a href="/"><img src="/images/inner_logo.png" width="180" alt="logo"></a></div>
		<div class="inner_navigation">
			<ul>
				...
				<li data-navigation="start"><a href="/pages/workshops" class="workshops <?php if (strpos($_SERVER['REQUEST_URI'], '/pages/workshops') > -1) { ?>active<?php } ?>">Workshops</a></li>
				...
				<li class="buttonArea"><div target="_new" class="action_button"><a href="http://portal.designforchange.us" target="_new">Login</a></div></li>
				<li class="buttonArea"><div target="_new" class="action_button blue"><a href="/pages/donate">Donate</a></div></li>
			</ul>
