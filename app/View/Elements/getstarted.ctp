<div class="leftnav">
  ...
  <ul>
    ...
    <li onclick="javascript:window.location.href = '/dfcusa/pages/getstarted/resources';" <?php if (strpos($_SERVER['REQUEST_URI'], '/pages/getstarted/resources') > -1) { ?>class="active hide"<?php } ?>><p>Additional Resources</p></li>
  </ul>
  <div class="clear"></div>
</div>
