<div class="leftnav">
  ...
  <ul>
    ...
    <li onclick="javascript:window.location.href = '/dfcusa-pm/pages/login#register';" <?php if (strpos($_SERVER['REQUEST_URI'], '/pages/getstarted/register') > -1) { ?>class="active"<?php } ?>><p>Register</p></li>
